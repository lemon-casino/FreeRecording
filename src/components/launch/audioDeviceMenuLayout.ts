export const AUDIO_DEVICE_MENU_WIDTH = 380;
export const AUDIO_DEVICE_MENU_COLUMN_WIDTH = 260;
export const AUDIO_DEVICE_MENU_MAX_COLUMNS = 3;
export const AUDIO_DEVICE_MENU_MAX_WIDTH =
	AUDIO_DEVICE_MENU_COLUMN_WIDTH * AUDIO_DEVICE_MENU_MAX_COLUMNS;

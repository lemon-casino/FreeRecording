			...
			<DialogContent className="bg-[#09090b] border-white/10 text-white max-w-[420px] max-h-[85vh] flex flex-col">
				<DialogHeader className="shrink-0">
					<DialogTitle className="flex items-center gap-2 text-sm">
						<Keyboard className="w-4 h-4 text-[#C24B72]" />
						{t("title")}
					</DialogTitle>
				</DialogHeader>
										...
										<div className="flex items-center justify-between py-1.5 px-1 border-b border-white/5">
											...
											<button
												...
												className={[
													...
													isCapturing
														? "bg-[#C24B72]/20 border-[#C24B72] text-[#C24B72] animate-pulse"
														: hasConflict
															? "bg-amber-500/10 border-amber-500/50 text-amber-400"
															: "bg-white/5 border-white/10 text-slate-200 hover:border-[#C24B72]/50 hover:text-[#C24B72] cursor-pointer",
												].join(" ")}
											>
				...
				<DialogFooter className="shrink-0 flex gap-2 sm:justify-between mt-2">
					...
					<div className="flex gap-2">
						...
						<Button
							size="sm"
							className="bg-[#C24B72] hover:bg-[#A83A5F] text-white"
							onClick={handleSave}
						>
							{tc("actions.save")}
						</Button>

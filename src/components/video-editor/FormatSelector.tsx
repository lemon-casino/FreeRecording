				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#C24B72]/50 focus:ring-offset-2 focus:ring-offset-[#09090b]",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#C24B72]/20 text-[#C24B72]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#C24B72]" />
						)}
					</button>
				);
			})}
